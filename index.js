...
function  enviar(){
    ...
    if(option.value == "voy"){
        mensajes = ` <a id="envio" href="https://api.whatsapp.com/send?phone=3517710599&text=Hola, soy ${nombre.value} y voy a los 15 de Sele.">enviar</a>`
    }else{
        mensajes = ` <a id="envio" href="https://api.whatsapp.com/send?phone=3517710599&text=Hola, soy ${nombre.value} y no puedo ir a los 15 de Sele.">enviar</a>`
    }
